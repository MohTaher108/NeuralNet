...
# Helper Functions
from resources.helpers import shuffle_data, batch_split
...
class NeuralNet:
    ...
    def train(self, features, labels, epochs=1000, batch_size=32, learning_rate=0.1, rel_tol=1e-4, loss_step=50):
    ...
    def gradient_descent(self, features, labels, epochs, batch_size, learning_rate, rel_tol, loss_step):
        for epoch in range(epochs):
            ...
            features_batches, labels_batches = batch_split(features_shuffled, labels_shuffled, batch_size)
